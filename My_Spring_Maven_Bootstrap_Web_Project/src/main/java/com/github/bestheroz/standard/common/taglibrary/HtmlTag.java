...
public class HtmlTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		this.makeLinkTag("https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css");
		...
		this.makeScriptTag("https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js");
		this.makeScriptTag("https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js");
		...
		this.sb.append("const CONTEXT_PATH = '" + CommonCode.CONTEXT_PATH + "';");
		this.sb.append("</script>");
		...
		if (StringUtils.equals(this.table, CommonCode.YES)) {
			this.makeLinkTag("https://cdn.datatables.net/1.10.18/css/dataTables.bootstrap.min.css");
			this.makeLinkTag("https://cdn.datatables.net/buttons/1.5.4/css/buttons.bootstrap.min.css");
			this.makeLinkTag("https://cdn.datatables.net/responsive/2.2.2/css/responsive.bootstrap.min.css");
			this.makeLinkTag("https://cdn.datatables.net/fixedcolumns/3.2.5/css/fixedColumns.bootstrap.min.css");
			this.makeLinkTag("https://cdn.datatables.net/fixedheader/3.1.4/css/fixedHeader.bootstrap.min.css");
			this.makeLinkTag("https://cdn.datatables.net/select/1.2.6/css/select.bootstrap.min.css");
			...
			this.makeScriptTag("https://cdn.datatables.net/1.10.18/js/dataTables.bootstrap.min.js");
			this.makeScriptTag("https://cdn.datatables.net/responsive/2.2.2/js/dataTables.responsive.min.js");
			this.makeScriptTag("https://cdn.datatables.net/responsive/2.2.2/js/responsive.bootstrap.min.js");
			this.makeScriptTag("https://cdn.datatables.net/buttons/1.5.4/js/dataTables.buttons.min.js");
			this.makeScriptTag("https://cdn.datatables.net/buttons/1.5.4/js/buttons.bootstrap.min.js");
		...
		if (StringUtils.equals(this.handlebars, CommonCode.YES)) {
			this.makeScriptTag("https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/4.1.1/handlebars.min.js");
			this.makeScriptTag(CommonCode.PATH_JS + "/MyHandlebars.js");
		}
		if (!StringUtils.equals(this.icon, CommonCode.NO)) {
			this.makeLinkTag("https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css");
		}
		...
		if (StringUtils.equals(this.textEditor, CommonCode.YES)) {
			this.makeLinkTag("https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.11/summernote.css");
			this.makeLinkTag(CommonCode.PATH_CSS + "/MyTextEditor.css");
			this.makeScriptTag("https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.11/summernote.min.js");
			this.makeScriptTag("https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.11/lang/summernote-ko-KR.min.js");
			this.makeScriptTag(CommonCode.PATH_JS + "/MyTextEditor.js");
		}

		if (StringUtils.equals(this.validator, CommonCode.YES)) {
			this.makeScriptTag("https://cdnjs.cloudflare.com/ajax/libs/validator/10.11.0/validator.min.js");
			this.makeScriptTag("https://cdnjs.cloudflare.com/ajax/libs/parsley.js/2.8.1/parsley.min.js");
			this.makeScriptTag("https://cdn.jsdelivr.net/npm/parsleyjs@2.8.1/dist/i18n/ko.js");
